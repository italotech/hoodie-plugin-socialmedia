...
module.exports = function (hoodie) {
  ...
  SocialMedia.getPost = function (db, task) {
    ...
    async.series([
        async.apply(_verifyAttrs, task, 'postObject'),
        async.apply(_verifyAttrs, task.postObject, 'id'),
...
//        async.apply(_verifyAttrs, task, 'userId'),
  ...
  SocialMedia.comment = function (db, task) {
    ...
    async.series([
        async.apply(_verifyAttrs, task, 'postObject'),
        async.apply(_verifyAttrs, task.postObject, 'id'),
        async.apply(_verifyAttrs, task, 'commentObject'),
        async.apply(_findPost, task, db),
  ...
  SocialMedia.count = function (db, task) {
    ...
    async.series([
        async.apply(_verifyAttrs, task, 'postObject'),
        async.apply(_verifyAttrs, task.postObject, 'id'),
        async.apply(_verifyAttrs, task, 'countType'),
        async.apply(_findPost, task, db),
  ...
  SocialMedia.updateComment = function (db, task) {
    ...
    async.series([
        ...
        async.apply(_verifyAttrs, task.postObject, 'id'),
        async.apply(_verifyAttrs, task, 'commentObject'),
        async.apply(_verifyAttrs, task.commentObject, 'id'),
